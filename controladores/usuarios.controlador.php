...
class ControladorUsuarios{
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingPassword"])){
				...
				if($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $encriptar){
					...
					if($respuesta["estado"] == 1){
						...
						echo '<br>
							<div class="alert alert-danger">El usuario no está habilitado</div>';
	...
	static public function ctrMostrarUsuariosMedico($item, $valor){

		$tabla = "usuario";

		$respuesta = ModeloUsuarios::mdlMostrarUsuariosMedico($tabla, $item, $valor);
