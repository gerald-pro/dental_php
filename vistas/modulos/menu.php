...
<nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="lista-citas" class="nav-link">
          ...
          <li class="nav-item">
            <a href="razonsocial" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="plantratamiento" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Administrar Plan de Tratamientos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="crear-plan-tratamiento" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Crear Plan de Tratamientos</p>
                </a>
              </li>
